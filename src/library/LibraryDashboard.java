...
public class LibraryDashboard {
    ...
    """;
        ...
        addBtn.setOnMouseEntered(e -> addBtn.setStyle(buttonStyle + "-fx-background-color:#2a5298; -fx-text-fill:white;"));
        addBtn.setOnMouseExited(e -> addBtn.setStyle(buttonStyle));

        deleteBtn.setOnMouseEntered(e -> deleteBtn.setStyle(buttonStyle + "-fx-background-color:#2a5298; -fx-text-fill:white;"));
        deleteBtn.setOnMouseExited(e -> deleteBtn.setStyle(buttonStyle));

        searchBtn.setOnMouseEntered(e -> searchBtn.setStyle(buttonStyle + "-fx-background-color:#2a5298; -fx-text-fill:white;"));
        searchBtn.setOnMouseExited(e -> searchBtn.setStyle(buttonStyle));

        statbtn.setOnMouseEntered(e -> statbtn.setStyle(buttonStyle + "-fx-background-color:#2a5298; -fx-text-fill:white;"));
